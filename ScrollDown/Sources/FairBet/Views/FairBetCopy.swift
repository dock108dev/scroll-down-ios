...
enum FairBetCopy {
    ...
    static func marketLabel(for marketKey: String, apiLabel: String? = nil) -> String {
        ...
        case "player_home_runs": return "Home Runs"
        case "player_rbi": return "RBIs"
        case "player_stolen_bases": return "Stolen Bases"
        case "player_strikeouts": return "Pitcher Ks"
        case "player_total_bases": return "Total Bases"
