...
final class RealGameService: GameService {
    ...
    private var estCalendar: Calendar {
        ...
        calendar.timeZone = TimeZone(identifier: "America/New_York") ?? TimeZone(secondsFromGMT: -18000)!
        return calendar
    }
    ...
    private var dateFormatter: DateFormatter {
        ...
        formatter.timeZone = TimeZone(identifier: "America/New_York") ?? TimeZone(secondsFromGMT: -18000)!
        return formatter
    }
